...
namespace TuristRegistar.Migrations
{
    ...
    [Migration("20200809203601_NewConversationColumnLIDT")]
    partial class NewConversationColumnLIDT
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TuristRegistar.Data.Models.Conversations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("IdentUser1Id");

                    b.Property<string>("IdentUser2Id");

                    b.Property<DateTime>("LastIneractionDateTime");

                    b.Property<bool>("Unread");

                    b.Property<string>("UnredIdentUserId");

                    b.HasKey("Id");

                    b.HasIndex("IdentUser1Id");

                    b.HasIndex("IdentUser2Id");
            ...
            modelBuilder.Entity("TuristRegistar.Data.Models.Messages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("SendingIdentUserId");

                    b.HasKey("Id");

                    b.HasIndex("ConversationId");

                    b.HasIndex("SendingIdentUserId");
            ...
            modelBuilder.Entity("TuristRegistar.Data.Models.Conversations", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "IdentUser1")
                        .WithMany()
                        .HasForeignKey("IdentUser1Id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "IdentUser2")
                        .WithMany()
                        .HasForeignKey("IdentUser2Id")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("TuristRegistar.Data.Models.Messages", b =>
                {
                    b.HasOne("TuristRegistar.Data.Models.Conversations", "Conversation")
                        .WithMany()
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "SendingIdentUser")
                        .WithMany()
                        .HasForeignKey("SendingIdentUserId");
                });
